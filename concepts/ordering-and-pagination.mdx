...
description: "Sort with Order.asc(), Order.desc(), or Order.none(), and pass limit plus a page number to Criteria for automatic skip calculation and Paginate<T> results."
---
