...
description: "Learn all 12 filter operators in ts-mongo-criteria — from EQUAL and BETWEEN to OR and IN — with TypeScript examples and their MongoDB query equivalents."
---
