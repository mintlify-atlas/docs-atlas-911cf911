...
description: "Singleton MongoClient manager for ts-mongo-criteria. Reads MONGO_URI, caches the connection via createClient(), and releases it with closeClient()."
---
