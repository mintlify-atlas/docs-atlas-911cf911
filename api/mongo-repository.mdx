...
description: "MongoRepository is the abstract base class providing one, many, list, upsert, and delete operations. Extend it with collectionName() and ensureIndexes() to create a typed repository."
---
