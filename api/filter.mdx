...
description: "FilterInputValue is a union type supporting primitives, primitive arrays, BetweenValue objects, and OrCondition arrays — each used by a specific operator."
---
