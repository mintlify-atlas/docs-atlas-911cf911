---
title: "Order, OrderBy, and OrderType — ts-mongo-criteria API Reference"
sidebarTitle: "Order"
...
- When both are provided, `OrderType.fromValue()` parses the direction string (`"asc"`, `"desc"`, `"none"`).
- When either is omitted, `Order.none()` is returned.
